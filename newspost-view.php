    ...
    <div class="container8">
      <div class="card">
        <div class="box">
          ...
          <p style="top:0px;">Your Posted News Details -   &nbsp; &nbsp; &nbsp; <b style="font-weight:300;font-size:35px;">#<?php echo $row['news_id'];?></b></p> 
          ...
          <div class="row" >
            ...
            <tr style="width:100%;">
                ...
                <td style="width:100%;">
                     ...
                     <center> <h3 style="text-align:left;font-weight:200;"><b style="font-size:30px;font-weight:500;"><?php echo $row['news_title'];?></b></h3>  </center> 
            ...
            <tr style="width:100%;">
                ...
                <td style="width:100%;">
                      ...
                      <h6 style="text-align:left;"><?php echo $row['news_description'];?></h6>
            ...
            <tr>
                     ...
                     <div class="popupee">
                         ...
                         <img  style=" width:280px; height:280px; align:left;"  src="<?php echo "news/".$row['news_img'];?>">
              ...
              <table style="width:100%; table-layout:auto; bottom=0px">
                <tr style="width:100%;">
                  <td style="width:15%;"> 
                    ...
                    <h3> <ion-icon name="heart-outline"></ion-icon>       <?php echo $row['news_likes'];?></h3> 

                </td>
                  <td style="width:15%;">
                
                  <h3> <ion-icon name="eye-outline"></ion-icon>   <?php echo $row['news_likes'];?></h3> 
                  
                
                </td>
                  <td style="width:25%;">
                
                <a href="download.php?file=<?php echo "news/".$row['news_document'];?>"> <ion-icon name="cloud-download-outline"></ion-icon> Download</a>
                ...
                <td style="width:45%;">
                  ...
                  <h5> <b style="font-size: 1.3em; font-weight: 300; letter-spacing:1.2px;">Uploaded On: <?php echo $row['news_uploaded_time'];?>   </b>        </h5>
