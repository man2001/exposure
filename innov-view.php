...
$query = "SELECT * FROM innovation where innov_id = '$innov_id'";
    ...
    <div class="container8">
      <div class="card">
        <div class="box">
          ...
          <p style="top:0px;">Your Posted News Details -   &nbsp; &nbsp; &nbsp; <b style="font-weight:300;font-size:35px;">#<?php echo $row['innov_id'];?></b></p> 
          ...
          <div class="row" >
            ...
            <tr style="width:100%;">
                ...
                <td style="width:100%;">
                      ...
                      <h6 style="text-align:left;"><?php echo $row['innov_solution'];?></h6>
              ...
              <table style="width:100%; table-layout:auto; bottom=0px">
                <tr style="width:100%;">
                  <td style="width:15%;"> 
                    ...
                    <h3> <ion-icon name="heart-outline"></ion-icon>       <?php echo $row['innov_likes'];?></h3> 

                </td>
                  <td style="width:15%;">
                
                  <h3> <ion-icon name="eye-outline"></ion-icon>   <?php echo $row['innov_likes'];?></h3> 
