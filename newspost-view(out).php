...
$query = "SELECT * FROM news INNER JOIN users ON users.user_id = news.user_id where news_id = '$news_id'";
    ...
    <div class="container8">
      <div class="card">
        <div class="box">
          ...
          <p style="top:0px;">Detailed News View-   &nbsp; &nbsp; &nbsp; <b style="font-weight:300;font-size:35px;">#<?php echo $row['news_id'];?></b></p> 
